...
namespace Catalog.Repositories
{
    public class InMemItemsRepository {
        ...
        public IEnumerable<Item> GetItems() { // We can call this from anywhere to get all our data
            return items;
        }        

        public Item? GetItem(Guid id) { // Use this anywhere to get an item via is Guid
